...
> **FaktumAI note:** This article is an editorial summary and analysis of the interview. All claims and figures are drawn from the provided source material; nothing has been added from outside the interview. Readers should evaluate the claims independently and verify critical figures from original sources.

## Key figures

<MetricCards items={[
  { label: 'OpenAI + Anthropic servers (estimate)', value: '≈ $300 bn', description: 'Zitron\'s calculation from the interview' },
  { label: 'Goldman Sachs AI build-out 2031', value: '$7.6 trillion', description: 'Tracking Trillions report' },
  { label: 'Hyperscaler capex 2026', value: '$1 trillion', description: 'Meta, Google, Amazon, Microsoft' },
  { label: 'NVIDIA GPUs / year', value: '6 million', description: 'Last year\'s shipments per the interview' },
]} />
