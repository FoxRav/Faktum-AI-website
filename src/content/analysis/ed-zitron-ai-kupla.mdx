...
description: "Kysymys, jonka ympärillä koko haastattelu pyörii: mihin kaikki nuo GPU:t ja datakeskukset oikeasti menevät? Analyysi Ed Zitronin Tech Report -haastattelusta — hyperscalerien kierrätysrahoitus ja datakeskusten toteuma."
...
> **FaktumAI huomio:** Tämä artikkeli on toimituksellinen tiivistelmä ja analyysi haastattelusta. Kaikki väitteet ja luvut on poimittu annetusta aineistosta; mitään ei ole lisätty haastattelun ulkopuolelta. Lukijan tulee arvioida väitteet itsenäisesti ja tarkistaa kriittiset luvut alkuperäisistä lähteistä.

## Avainluvut

<MetricCards items={[
  { label: 'OpenAI + Anthropic -palvelimiin (arvio)', value: '≈ 300 mrd $', description: 'Zitronin laskelma haastattelusta' },
  { label: 'Goldman Sachs AI-rakennus 2031', value: '7,6 biljoonaa $', description: 'Tracking Trillions -raportti' },
  { label: 'Hyperscaler capex 2026', value: '1 biljoona $', description: 'Meta, Google, Amazon, Microsoft' },
  { label: 'NVIDIA GPU:t / vuosi', value: '6 milj.', description: 'Viime vuoden toimitukset haastattelun mukaan' },
]} />
...
4. "Kolme datakeskusratsastajaa": rakennusvaiheessa oleva datakeskus peruutetaan, suunniteltu datakeskus peruutetaan, **toimiva datakeskus kuolee**
